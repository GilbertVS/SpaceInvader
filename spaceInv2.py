...
from posicions2 import posicions2
from xoc2 import xoc2
...
def Spaceinvader2() :
    global sortir, crash
    crash, sortir, so1, pl_mort1, pl_mort2 = False, False, True, False, False
    score2, score1, level = 0, 0, 1
    ...
    while not sortir :       
        ...
        while run :
            ...
            if crash == False :
                ...
                if keys[100] :
                    x2 += vel
                if keys[119] and y2 > alsada/2 - vel :
                    y2 -= vel
                if keys[115] and y2 < alsada - height - vel :
                    y2 += vel
                ...
                if y_proj+int(alsada/20) >= alsada :
                    ...
                    while retornale :
                        ...
                        if aleatori == 1 and nau_morta1 == False  :
                            ...
                            retornale = True
                # tocat el projectil enemic en el jugador 1        
                if (x < x_proj < x+width) and (y < y_proj < y+height) :
                    pl_mort1 = True
                    if pl_mort2 == True :
                        crash = True
                # tocat el projectil enemic en el jugador 2
                if (x2 < x_proj < x2+width) and (y2 < y_proj < y2+height) :
                    pl_mort2 = True
                    if pl_mort1 == True :
                        crash = True
            #coalició d'un tret amb l'elienigena
            if x_ali17 <  x_tret2  <  x_ali17+width/2  and  y_ali17 <  y_tret2 <  y_ali17+height and mort17 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3  
                 cont_ali17 +=1
                 if  cont_ali17 > 2 :
            ...
            if x_ali17 < x_tret1 < x_ali17+width/2  and  y_ali17 < y_tret1< y_ali17+height  and mort17 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali17 +=1
                 if  cont_ali17 > 2 :
                     mort17  = True
                     score1 += 1
            if x_ali16 < x_tret2 < x_ali16+width/2  and  y_ali16 < y_tret2< y_ali16+height  and mort16 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3       
                 cont_ali16 += 1
                 if  cont_ali16 > 2 :
            ...
            if x_ali16 < x_tret1 < x_ali16+width/2  and  y_ali16 < y_tret1< y_ali16+height  and mort16 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali16 += 1
                 if  cont_ali16 > 2 :
                     mort16  = True
                     score1 += 1
            if x_ali15 < x_tret2 < x_ali15+width/2  and  y_ali15 < y_tret2< y_ali15+height  and mort15 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3      
                 cont_ali15 +=1
                 if  cont_ali15 > 2 :
            ...
            if x_ali15 < x_tret1 < x_ali15+width/2  and  y_ali15 < y_tret1< y_ali15+height  and mort15 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali15 +=1
                 if  cont_ali15 > 2 :
                     mort15  = True
                     score1 += 1
            if x_ali14 < x_tret2 < x_ali14+width/2  and  y_ali14 < y_tret2< y_ali14+height  and mort14 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3
                 cont_ali14 += 1
                 if  cont_ali14 > 2 :
                     mort14  = True
                     score2 += 1                 
            if x_ali14 < x_tret1 < x_ali14+width/2  and  y_ali14 < y_tret1< y_ali14+height  and mort14 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali14 += 1
                 if  cont_ali14 > 2 :
                     mort14  = True
                     score1 += 1
            if x_ali13 < x_tret2 < x_ali13+width/2  and  y_ali13 < y_tret2< y_ali13+height  and mort13 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3      
                 cont_ali13 +=1
                 if  cont_ali13 > 2 :
            ...
            if x_ali13 < x_tret1 < x_ali13+width/2  and  y_ali13 < y_tret1< y_ali13+height  and mort13 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali13 +=1
                 if  cont_ali13 > 2 :
            ...
            if x_ali12 < x_tret1 < x_ali12+width/2  and  y_ali12 < y_tret1< y_ali12+height  and mort12 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali12 += 1
                 if  cont_ali12 > 2 :
                     mort12  = True
                     score1 += 1
            if x_ali11 < x_tret2 < x_ali11+width/2  and  y_ali11 < y_tret2 < y_ali11+height  and mort11 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3     
                 cont_ali11 += 1
                 if  cont_ali11 > 2 :
            ...
            if x_ali11 < x_tret1 < x_ali11+width/2  and  y_ali11 < y_tret1< y_ali11+height  and mort11 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali11 += 1
                 if  cont_ali11 > 2 :
                     mort11  = True
                     score1 += 1
            if x_ali10  < x_tret2 < x_ali10+width/2  and  y_ali10  < y_tret2< y_ali10+height  and mort10 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3     
                 cont_ali10 += 1
                 if  cont_ali10 > 2 :
            ...
            if x_ali10 < x_tret1 < x_ali10+width/2  and  y_ali10 < y_tret1<y_ali10+height  and mort10 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali10 += 1
                 if  cont_ali10 > 2 :
                     mort10  = True
                     score1 += 1
            if x_ali9 < x_tret2 < x_ali9+width/2  and  y_ali9 < y_tret2< y_ali9+height  and mort9 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3    
                 cont_ali9 += 1
                 if  cont_ali9 > 2 :
            ...
            if x_ali9 < x_tret1 < x_ali9+width/2  and  y_ali9 < y_tret1< y_ali9+height  and mort9 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali9 += 1
                 if  cont_ali9 > 2 :
                     mort9  = True
                     score1 += 1
            if x_ali8 < x_tret2 < x_ali8+width/2  and  y_ali8 < y_tret2< y_ali8+height  and mort8 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3    
                 cont_ali8 +=1
                 if  cont_ali8 > 2 :
            ...
            if x_ali8 < x_tret1 < x_ali8+width/2  and  y_ali8 < y_tret1< y_ali8+height  and mort8 == False and pl_mort1 == False:
                 x_tret1 = x + height/2
                 y_tret1 = y + vel*3
                 cont_ali8 +=1
                 if  cont_ali8 > 2 :
                     mort8  = True
                     score1 += 1
            if x_ali7 < x_tret2 < x_ali7+width/2  and  y_ali7 < y_tret2< y_ali7+height  and mort7 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3      
                 cont_ali7 +=1
                 if  cont_ali7 > 2 :
            ...
            if x_ali7 < x_tret1 < x_ali7+width /2 and  y_ali7 < y_tret1< y_ali7+height  and mort7 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali7 +=1
                 if  cont_ali7 > 2 :
                     mort7  = True
                     score1 += 1
            if x_ali6 < x_tret2 < x_ali6+width/2  and  y_ali6< y_tret2< y_ali6+height  and mort6 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3     
                 cont_ali6 += 1
                 if  cont_ali6 > 2 :
            ...
            if x_ali6 < x_tret1 < x_ali6+width/2  and  y_ali6< y_tret1< y_ali6+height  and mort6 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali6 += 1
                 if  cont_ali6 > 2 :
                     mort6  = True
                     score1 += 1
            if x_ali5 < x_tret2 < x_ali5+width/2  and  y_ali5 < y_tret2 < y_ali5+height  and mort5 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3      
                 cont_ali5 += 1
                 if  cont_ali5 > 2 :
            ...
            if x_ali5 < x_tret1 < x_ali5+width/2  and  y_ali5 < y_tret1< y_ali5+height  and mort5 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali5 += 1
                 if  cont_ali5 > 2 :
                     mort5  = True
                     score1 += 1
            if x_ali4  < x_tret2 < x_ali4+width/2  and  y_ali4  <  y_tret2 <  y_ali4+height  and mort4 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel     
                 cont_ali4 += 1
                 if  cont_ali4 > 2 :
            ...
            if x_ali4 < x_tret1 < x_ali4+width/2  and  y_ali4 < y_tret1<y_ali4+height  and mort4 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali4 += 1
                 if  cont_ali4 > 2 :
                     mort4  = True
                     score1 += 1
            if x_ali3 < x_tret2 < x_ali3+width/2  and  y_ali3  <  y_tret2 <  y_ali3+height  and mort3 == False and pl_mort2 == False:
                 x_tret2 = x2 + height/2
                 y_tret2 = y2 + vel  
                 cont_ali3 += 1
                 if  cont_ali3 > 2 :
            ...
            if x_ali3 < x_tret1 < x_ali3+width/2  and  y_ali3< y_tret1< y_ali3+height  and mort3 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali3 += 1
                 if  cont_ali3 > 2 :
                     mort3  = True
                     score1 += 1
            if x_ali2 < x_tret2 < x_ali2+width/2  and  y_ali2< y_tret2< y_ali2+height  and mort2 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3     
                 cont_ali2 += 1
                 if  cont_ali2 > 2 :
            ...
            if x_ali2< x_tret1 < x_ali2+width/2  and  y_ali2< y_tret1< y_ali2+height  and mort2 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel
                 cont_ali2 += 1
                 if  cont_ali2 > 2 :
                     mort2  = True
                     score1 += 1
            if x_ali1 < x_tret2 < x_ali1+width/2  and  y_ali1 < y_tret2< y_ali1+height  and mort1 == False and pl_mort2 == False:
                 x_tret2 = x2 + height /2
                 y_tret2 = y2 + vel*3      
                 cont_ali1 += 1
                 if  cont_ali1 > 2 :
            ...
            if x_ali1 < x_tret1 < x_ali1+width/2  and  y_ali1 < y_tret1< y_ali1+height  and mort1 == False and pl_mort1 == False:
                 x_tret1 = x + height /2
                 y_tret1 = y + vel*3
                 cont_ali1 += 1
                 if  cont_ali1 > 2 :
                     mort1  = True
                     score1 += 1
            if x_nau1 < x_tret2 < x_nau1+width-5*vel and y_nau1 < y_tret2 < y_nau1+height and nau_morta1 ==False and pl_mort2 == False:
                x_tret2 = x2 + height /2
                y_tret2 = y2 + vel*3 
                cont_nau1 += 1
                if cont_nau1 > 4 :
            ...
            if x_nau1 < x_tret1 < x_nau1+width-4*vel and y_nau1 < y_tret1 <y_nau1+height and nau_morta1 == False and pl_mort1 == False:
                x_tret1 = x + height /2
                y_tret1 = y + vel*3
                cont_nau1 += 1
                if cont_nau1 > 4 :
                    nau_morta1 = True
                    score1 += 2
            if x_nau2 < x_tret2 < x_nau2+width-5*vel and y_nau2 < y_tret2 < y_nau2+height and nau_morta2 ==False and pl_mort2 == False:
                x_tret2 = x2 + height /2
                y_tret2 = y2 + vel*3   
                cont_nau2 += 1
                if cont_nau2 > 4 :
            ...
            if x_nau2 < x_tret1 < x_nau2+width-4*vel and y_nau2 < y_tret1 <y_nau2+height and nau_morta2 == False and pl_mort1 == False:
                x_tret1 = x + height /2
                y_tret1 = y + vel*3
                cont_nau2 += 1
                if cont_nau2 > 4 :
                    nau_morta2 = True
                    score1 += 2
            if x_nau3 < x_tret2 < x_nau3+width-5*vel and y_nau3 < y_tret2 < y_nau3+height and nau_morta3 ==False and pl_mort2 == False:
                x_tret2 = x2 + height /2
                y_tret2 = y2 + vel*3 
                cont_nau3 += 1
                if cont_nau3 > 4 :
            ...
            if x_nau3 < x_tret1 < x_nau3+width-4*vel and y_nau3 < y_tret1 <y_nau3+height and nau_morta3 == False and pl_mort1 == False:
                x_tret1 = x + height /2
                y_tret1 = y + vel*3
                cont_nau3 += 1
                if cont_nau3 > 4 :
            ...
            marcador2 = tipograf.render("Player 2: {}".format(score2), 1, (0, 0, 244))
            win.blit(marcador2, (vel, vel))
            nivell = tipograf.render("Level: {}".format(level), 1, (244, 122, 0))
            win.blit(nivell, (amplada*0.37, vel))
            marcador = tipograf .render("Player 1: {}".format(score1), 1, (244, 0, 0))
            win.blit(marcador, (amplada*0.63, vel))
            ...
            if pl_mort2 == False :
                pygame.draw.line(win, (0, 0, 177), [x_tret2, y_tret2], [x_tret2, y_tret2+int(alsada/20)], int(amplada/200))
                win.blit(pl_mach2, (x2, y2))
            if nau_morta1 == False :
